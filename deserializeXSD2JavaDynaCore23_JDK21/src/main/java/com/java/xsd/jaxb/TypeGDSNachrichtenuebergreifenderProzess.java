...
/**
 * Die Elemente dieses Types dienen der �bermittlung von Informationen zu einem mehrere Nachrichten umfassenden Gesch�ftsprozess. Sofern diese Informationen f�r die automatisierte Abarbeitung des Gesch�ftsprozesses nicht ausreichen, m�ssen unter den Kommunikationspartnern bilateral weitere Regeln abgestimmt sein. Dies gilt insbesondere f�r den Fall, dass der Versand zusammengeh�riger Dokumente (z.B. einer Akte) auf mehrere Nachrichten verteilt werden soll. Dieses sogenannte fachliche Splitting darf nur nach vorheriger Abstimmung mit der BLK-AG IT-Standards erfolgen.
 * 
